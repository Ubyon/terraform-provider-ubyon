...
type UpdateAppEndpointRaw struct {
	// The accesstype of an appendpoint NATIVE AppEndpointAccessTypeNative BROWSER AppEndpointAccessTypeBrowser
	AccessType string                  `json:"accessType,omitempty"`
	Addr       *AppEndpointAddr        `json:"addr,omitempty"`
	Attributes IsAppEndpointAttributes `json:"attributes,omitempty"`
	// The browser access settings to be configured for an appendpoint oneOf: \\- $ref: '#/components/schemas/NewBrowserAccessSettings' \\- $ref: '#/components/schemas/UpdateBrowserAccessSettings'
	BrowserAccessSettings interface{} `json:"browserAccessSettings,omitempty"`
	...
	Port           *AppEndpointPort `json:"port,omitempty"`
